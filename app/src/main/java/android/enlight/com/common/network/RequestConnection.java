...
import android.enlight.com.common.network.model.DownloadParamModel;
...
public class RequestConnection {
     ...
     */
    public String doGet(String httpUrl, Map<String, String> params,boolean ifHead)
            throws NetworkConnectException, NetworkNotException, NetworkTimeoutException, NetworkForceCloseException {
        return doRequest(false,ifHead, httpUrl, params);
    }
     ...
     * @throws NetworkForceCloseException
     */
    public String doPost(String httpUrl, Map<String, String> params,boolean ifHead)
            throws NetworkConnectException, NetworkNotException, NetworkTimeoutException, NetworkForceCloseException {
        return doRequest(true,ifHead, httpUrl, params);
    }
     ...
     * @throws NetworkForceCloseException
     */
    private String doRequest(boolean isPost,boolean ifHead, String httpUrl, Map<String, String> params)
            throws NetworkConnectException, NetworkNotException, NetworkTimeoutException, NetworkForceCloseException {
...
// 				Map<String, List<String>> responseHeaders = urlConnection.getHeaderFields();
                String header = urlConnection.getHeaderField("sessionid");
                //同步sessionid信息
                if (header != null && header.length() > 0) {
                    //ApplicationData.globalContext.getUserManager().setSessionId(header);
                }
...
//				}
     ...
     * @throws NetworkForceCloseException
     */
    public byte[] doDownloadFile(String url, DownloadParamModel downloadParamModel)
            throws NetworkConnectException, NetworkNotException, NetworkTimeoutException, NetworkForceCloseException {
        String filePath = downloadParamModel.getFilePath() + downloadParamModel.getFileName();
        long currentLength = downloadParamModel.getCurrentLength();
        long targetLength = downloadParamModel.getTargetLength();
        return doDownloadFile(url, filePath, currentLength, targetLength, null);
    }
...
//            }
            ...
            if (statusCode == 200 || statusCode == 206) {
                ...
                totalLength = val == null ? downloadLength : Long.parseLong(val.substring(val.indexOf("/") + 1));
                ...
                while (cLength < downloadLength || downloadLength == -1) {
